...
class ExerciseAdapter(private var data: ArrayList<Exercise>, private val context: Context) : RecyclerView.Adapter<ExerciseViewHolder>() {

    fun setData(exercises: ArrayList<Exercise>) {
        data = exercises

...
import com.example.mobdeve.s13.payao.malcolm.fitme.adapter.AddNewExerciseAdapter
import com.google.firebase.firestore.FirebaseFirestore

class AddNewExerciseActivity : AppCompatActivity() {


   // private lateinit var exerciseAdapter: AddNewExerciseAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sendBtn.setOnClickListener {
            // Add your logic to handle sending the new exercise
            finish()
        }
